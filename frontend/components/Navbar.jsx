...
export function Navbar() {
  ...
  return (
    <div className="fixed top-5 backdrop-blur-sm z-50 left-1/2 -translate-x-1/2 flex flex-row space-x-4 items-center justify-around border border-inherit rounded-lg lg:w-5/12 sm:w-4/5 shadow mt-4 p-4">
      {pageData.map((page) => {
